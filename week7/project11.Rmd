---
title: "project11--Analyzing "
author: "christine"
date: "2018年4月10日"
output: html_document
---

At First, I tried to analyze the data with time difference, but I couldn't combine the content of articles. Therefore, I tried to make the project easier by simply using tfidf to find keywords. I succeeded in this part, but I didn't know how to change the form of the data. When I tried to use ggplot2, there was an error message: ggplot2 doesn't know how to deal with data of class matrix. In brief, I failed this project. I was not able to visualize the data.
...
All in all, I've spent quite a long time on this project. It is a shame that I didn't make it. Hopefully, I will make more achievement in the following projects.
...
#It took me a while to figure out which 編碼 to save the file, and I tried all types to find the right one.

docnum = length(rawData)
mixseg = worker()
new_user_word(mixseg, c('賽爾提克','選秀大會','搬上檯面'))
#This is inspired by the sharing session during class. I took a look at the data. There were also words that are not cut correctly. In my case, there are only three big mistakes.
Alltoken = list()
Allfreq = list()
#listed all the words and phrases
for( c in 1:docnum )
