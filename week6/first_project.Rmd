...
At First, I tried to analyze the data with time difference, but I couldn??€î¨? combine the content of articles. Therefore, I tried to make the project easier by simply using tfidf to find keywords. I succeeded in this part, but I didn??€î¨? know how to change the form of the data. When I tried to use ggplot2, there was an error message: ggplot2 doesn??€î¨? know how to deal with data of class matrix. In brief, I failed this project. I was not able to visualize the data.
...
All in all, I??€î¨†e spent quite a long time on this project. It is a shame that I didn??€î¨? make it. Hopefully, I will make more achievement in the following projects.
...
#Confused, I don't know why there is a lot of blank space in my html. During class, I asked my group mate, ???¤??„æ???, he presumed that the reason might be that some articles have been deleted.
