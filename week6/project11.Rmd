...
#It took me a while to figure out which 蝺函Ⅳ to save the file, and I tried all types to find the right one.

docnum = length(rawData)
mixseg = worker()
new_user_word(mixseg, c('鞈賜????','?蝘憭扳??','?銝狗?'))
